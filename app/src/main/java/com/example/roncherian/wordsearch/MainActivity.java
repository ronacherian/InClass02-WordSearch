            ...
            for (String searchString : stringListToSearch){
                ...
                while (matcher.find()){
                    if (matcher.start()< 11){
                        ...
                        SpannableString str1= new SpannableString(searchingText.substring(matcher.start(),matcher.end()+30));
                        ...
                        if (searchString.length()<=21){
                            stringToGive = "..."+searchingText.substring(matcher.start()-10,matcher.end()+21-searchString.length())+"...";
                        } else {
                            stringToGive = "..."+searchingText.substring(matcher.start()-10,matcher.end());
                        }
